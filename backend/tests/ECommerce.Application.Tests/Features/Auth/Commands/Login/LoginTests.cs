...
public class LoginTests
{
    ...
    {
        _loginCommand.UserForLoginDto = new() { Email = "example@alikemaluysal.com", Password = "123456" };
    ...
    {
        _loginCommand.UserForLoginDto = new() { Email = "example@alikemaluysal.com", Password = "123456789" };
    ...
    {
        _loginCommand.UserForLoginDto = new() { Email = "halit1@alikemaluysal.com", Password = "123456" };
        await Assert.ThrowsAsync<BusinessException>(async () =>
        {
            await _loginCommandHandler.Handle(_loginCommand, CancellationToken.None);
        });
    ...
    {
        _loginCommand.UserForLoginDto = new() { Email = "halit1@alikemaluysal.com", Password = "1" };
    ...
    {
        _loginCommand.UserForLoginDto = new() { Email = "halit1@alikemaluysal.com", Password = null! };
        TestValidationResult<LoginCommand> validationResult = _validator.TestValidate(_loginCommand);
        validationResult.ShouldHaveValidationErrorFor(i => i.UserForLoginDto.Password);
    }
}
