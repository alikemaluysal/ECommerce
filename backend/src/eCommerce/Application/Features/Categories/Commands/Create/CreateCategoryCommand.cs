...
public class CreateCategoryCommand : IRequest<CreatedCategoryResponse>, ISecuredRequest, ICacheRemoverRequest, ILoggableRequest
{
    ...
    public class CreateCategoryCommandHandler : IRequestHandler<CreateCategoryCommand, CreatedCategoryResponse>
    {
        ...
        {
            await _categoryBusinessRules.CategoryNameShouldBeUniqueWhenCreating(request.Name, cancellationToken);
