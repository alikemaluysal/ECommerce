...
public class UpdateCategoryCommand : IRequest<UpdatedCategoryResponse>, ISecuredRequest, ICacheRemoverRequest, ILoggableRequest
{
    public Guid Id { get; set; }
    public UpdateCategoryRequest Dto { get; set; }
    ...
    public UpdateCategoryCommand(Guid id, UpdateCategoryRequest dto)
    {
        Id = id;
        Dto = dto;
    }
    ...
    public class UpdateCategoryCommandHandler : IRequestHandler<UpdateCategoryCommand, UpdatedCategoryResponse>
    {
        ...
        public async Task<UpdatedCategoryResponse> Handle(UpdateCategoryCommand request, CancellationToken cancellationToken)
        {
            ...
            await _categoryBusinessRules.CategoryNameShouldBeUniqueWhenUpdating(request.Id, request.Dto.Name, cancellationToken);

            category = _mapper.Map(request.Dto, category);
